...
exports.tree = exports.createNode = exports.createElement = undefined;
...
function createElement(tagName, attributes, parentElement) {
  ...
  if ((typeof attributes === 'undefined' ? 'undefined' : _typeof(attributes)) === 'object' && attributes) Object.assign(elem, attributes);
  if (attributes.id) {
    tree.id[attributes.id] = elem;
  }
  if (attributes.className) {
    if (Array.isArray(tree.class[attributes.className])) tree.class[attributes.className].push(elem);else tree.class[attributes.className] = [elem];
  }
  parentElement.appendChild(elem);
  elem.createChild = createElement;
  elem.createChildren = createChildren;
  elem.createTextNode = createNode;
  if (_elements2.default[tagName]) _elements2.default[tagName](elem);
  return elem;
}
...
exports.tree = tree;
},{"./elements":"elements.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","tree.js"], null)
